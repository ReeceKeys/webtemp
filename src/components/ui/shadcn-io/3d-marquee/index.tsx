...
export const ThreeDMarquee = ({ images, className }: ThreeDMarqueeProps) => {
  ...
  return (
    <div
  className={cn(
    "block h-[92vh] overflow-hidden rounded-2xl max-sm:h-100",
    className,
  )}
>
  {/* Top fade overlay */}
  ...
  <div className="flex size-full items-center justify-center">
    <div className="size-[1720px] shrink-0 scale-50 sm:scale-75 lg:scale-100">
      <div
        ...
        className="relative top-100 right-[50%] grid size-full origin-top-left grid-cols-4 gap-8 transform-3d"
      >
